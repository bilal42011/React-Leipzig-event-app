...
let iconobj={snow,rain,fog,wind,cloudy,partlycloudyday,partlycloudynight,clearday,clearnight};
...
let weatherlist=weatherresponse.data.locations["Leipzig,Germany"].values;    
...
<Grid item xs={6} sm={6} md={6} lg={6} xl={6}>
    <img src={iconobj[weathericon]} style={{width:"110px",height:"95px"}} />
    </Grid>
<Grid container item xs={6} sm={6} md={6} lg={6} xl={6}>
    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        <Typography variant="h5" fontWeight="bolder" fontFamily="brawler">
            <span style={{fontSize:"38px"}}>{day}</span>
            <span style={{marginLeft:"7px"}}>{weatheritem.temp}°C</span>
            </Typography>
    </Grid>
    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        <Typography variant="h6" fontSize="20px" fontWeight="bolder" fontFamily="brawler">
...
<Grid container item xs={6} sm={6} md={6} lg={6} xl={6}>
    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        <Typography variant="h5" fontWeight="bolder" fontFamily="helvetica">
            <span style={{fontSize:"38px"}}>{day}</span>
            <span style={{marginLeft:"7px"}}>{weatheritem.temp}°C</span>
            </Typography>
    </Grid>
    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        <Typography variant="h6" fontSize="20px" fontWeight="bolder" fontFamily="helvetica">
            {weatheritem.conditions}
            </Typography>
    </Grid>
    <Grid></Grid>
...
return <Grid  container item xs={12} sm={6} md={5} lg={3} xl={3}
 sx={{minHeight:"150px",marginTop:"2%",backgroundColor:"#301934",borderRadius:"5%",color:"white"}}>
{item}
</Grid>
